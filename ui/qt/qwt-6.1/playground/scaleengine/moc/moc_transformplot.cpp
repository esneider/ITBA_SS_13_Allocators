...
**
** Created: Thu Oct 31 19:58:06 2013
...
static const char qt_meta_stringdata_TransformPlot[] = {
    "TransformPlot\0\0selected(QwtTransform*)\0"
    ",on\0legendChecked(QVariant,bool)\0"
};
...
const QMetaObjectExtraData TransformPlot::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TransformPlot::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_TransformPlot,
      qt_meta_data_TransformPlot, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TransformPlot::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TransformPlot))
