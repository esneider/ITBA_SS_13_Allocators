...
**
** Created: Thu Oct 31 19:58:20 2013
...
static const char qt_meta_stringdata_Plot[] = {
    "Plot\0\0xRatio,yRatio\0resized(double,double)\0"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->resized((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Plot::resized(double _t1, double _t2)
{
