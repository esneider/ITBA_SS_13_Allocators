...
**
** Created: Thu Oct 31 19:54:38 2013
...
static const char qt_meta_stringdata_QwtDesignerPlugin__PlotCanvasInterface[] = {
...
const QMetaObjectExtraData QwtDesignerPlugin::PlotCanvasInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QwtDesignerPlugin::PlotCanvasInterface::staticMetaObject = {
    { &CustomWidgetInterface::staticMetaObject, qt_meta_stringdata_QwtDesignerPlugin__PlotCanvasInterface,
      qt_meta_data_QwtDesignerPlugin__PlotCanvasInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QwtDesignerPlugin::PlotCanvasInterface::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QwtDesignerPlugin__PlotCanvasInterface))
